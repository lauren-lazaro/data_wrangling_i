...
get rid of rows using `filter()` fitlering is usually based on something
that is in your df. given something inside the df, construct something
that says keep this or don’t keep this
